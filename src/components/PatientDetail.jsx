    ...
    <div className="max-w-7xl mx-auto">
      ...
      <div className="grid lg:grid-cols-3 gap-6">
        ...
        <div className="lg:col-span-1 space-y-6">
          ...
          <div className="bg-white rounded-2xl shadow-xl p-6">
            ...
            <div className="text-gray-600 space-y-2">
              ...
              <p className="text-sm">ID: {patient.patientId || patient.patient_id}</p>
            </div>
          </div>
          ...
          <div className="bg-white rounded-xl shadow-lg p-6">
            ...
            <div className="space-y-4">
              <div>
                <h4 className="text-sm font-semibold text-gray-600 mb-1">Code Status</h4>
                <p className="text-gray-800 font-medium">{codeStatus}</p>
              </div>

              <div>
                <h4 className="text-sm font-semibold text-gray-600 mb-1">Medical History</h4>
                <p className="text-gray-800">{medicalHistory || 'None documented'}</p>
              </div>

              {/* Vital Signs */}
              {patient.vitals && (
                <div>
                  <h4 className="text-sm font-semibold text-gray-600 mb-2">Latest Vitals</h4>
          ...
          <div className="bg-gradient-to-r from-purple-50 to-blue-50 rounded-xl p-4 border border-purple-200">
            <div className="flex items-center gap-2 text-sm">
              ...
              <span className="text-gray-700">
                Using <span className="font-semibold">{aiProvider === 'claude' ? 'Claude Sonnet 4' : 'GPT-4o'}</span>
              </span>
            </div>
          </div>
        </div>
        ...
        <div className="lg:col-span-2 space-y-6">
          {/* Action Buttons */}
          <div className="bg-white rounded-2xl shadow-xl p-6">
            <h3 className="text-xl font-bold text-gray-800 mb-4">Generate Handoff Notes</h3>
              ...
              <div className="bg-gray-50 rounded-lg p-4 mb-4 border-2 border-dashed border-gray-300">
                <div className="flex items-start gap-4">
                  ...
                  <div className="flex-1">
                    <p className="text-sm text-gray-600 mb-2">Handoff document uploaded</p>
                    <button
            ...
            <div className="bg-white rounded-2xl shadow-xl p-6">
              ...
              {isEditing ? (
                <textarea
                  ...
                  className="w-full h-96 p-4 border-2 border-gray-300 rounded-lg focus:border-blue-500 focus:ring-2 focus:ring-blue-200 outline-none font-mono text-sm resize-none"
                ...
                <div className="bg-gradient-to-br from-gray-50 to-blue-50 rounded-lg p-6 border border-gray-200">
                  <pre className="whitespace-pre-wrap text-gray-700 font-sans">{handoffNotes}</pre>
                </div>
              )}
            </div>
          )}
