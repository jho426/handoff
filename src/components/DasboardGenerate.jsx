          ...
          <div className="max-w-6xl mx-auto">
            <div className="text-center mb-12">
              ...
              <p className="text-xl text-gray-600">
                AI-powered tools to streamline patient handoff and care
                coordination
              </p>
            </div>
            ...
            <div className="grid md:grid-cols-2 gap-8">
              ...
              >
                ...
                <p className="text-gray-600 mb-4">
                  Upload a photo of a handoff whiteboard or sheet to get an
                  AI-powered summary with key patient information, vital signs,
                  and action items.
                </p>
              ...
              >
                ...
                <p className="text-gray-600 mb-4">
                  View and analyze patient records with AI-generated summaries
                  highlighting critical information, trends, and pending tasks.
                </p>
              ...
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <p className="text-gray-600">
                    This application helps healthcare professionals streamline
                    patient handoffs by leveraging AI to extract, summarize, and
                    organize critical patient information. Choose your preferred
                    AI provider and select a feature above to get started.
                  </p>
                </div>
              </div>
            </div>
